 ...
 */
public class TestSomeJob extends BackgroundJob {

    private static final Logger LOGGER = LoggerFactory.getLogger(TestSomeJob.class);
    ...
    public void executeJahiaJob(JobExecutionContext jobExecutionContext) throws Exception {
        LOGGER.info("Starting TestSomeJob execution {}", jobExecutionContext.getJobDetail().toString());
